...
vectorisations=["AVX2","AVX","SSE4_2"]
precisions=["s","d"]
operations=["potrf","trsm","syrk","gemm"]
#coeurs=[str(i) for i in range(2,35,2)] + [str(i) for i in range(1,36,2)]

coeurs=["1","24"]
fichiers = os.listdir("./")
for c in coeurs:
    resultats={"s":{"potrf":{ "AVX2":[],"AVX":[],"SSE4_2":[]},
                "trsm":{ "AVX2":[],"AVX":[],"SSE4_2":[]},
                "gemm":{ "AVX2":[],"AVX":[],"SSE4_2":[]},
                "syrk":{ "AVX2":[],"AVX":[],"SSE4_2":[]}},
           "d":{"potrf":{ "AVX2":[],"AVX":[],"SSE4_2":[]},
                "trsm":{ "AVX2":[],"AVX":[],"SSE4_2":[]},
                "gemm":{ "AVX2":[],"AVX":[],"SSE4_2":[]},
                "syrk":{ "AVX2":[],"AVX":[],"SSE4_2":[]}}}
    for p in precisions:
